...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _sections_photos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sections/_photos */ "./src/js/sections/_photos.js");
/* harmony import */ var _sections_faq__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./sections/_faq */ "./src/js/sections/_faq.js");
/* harmony import */ var _sections_header__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./sections/_header */ "./src/js/sections/_header.js");
/* harmony import */ var _sections_header__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_sections_header__WEBPACK_IMPORTED_MODULE_2__);
...
if (document.querySelector('.partners__slider')) {
  const partnersSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.partners__slider', {
    breakpoints: {
      320: {
        slidesPerView: 3,
        spaceBetween: 17
...
if (document.querySelector('.guide')) {
  const videoSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.guide__videos', {
  ...
  const brochureSlider = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.guide__brochures', {
    modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation],
    slidesPerView: 1,
    observer: true,
    observeParents: true,
      ...
      if (item) {
        ...
        this.items.forEach(currentItem => {
          if (currentItem !== item && currentItem.classList.contains('active')) {
            ...
            currentItem.querySelector('.accordeon__item-body').style.maxHeight = null;
          }
        });
    ...
    this.tabContainer.addEventListener('click', e => {
      if (e.target.classList.contains('tabs__btn')) {
        const tabsHandler = path => {
          ...
          this.tabContainer.querySelector(`[data-tabs-target="${path}"]`).classList.add('tabs__content-active');
        };
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_accordeon__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/accordeon */ "./src/js/functions/accordeon.js");

if (document.querySelector('.faq')) {
  new _functions_accordeon__WEBPACK_IMPORTED_MODULE_0__["default"]('.faq').renderAccordeonWithHead();
}

/***/ }),

/***/ "./src/js/sections/_guide.js":
/*!***********************************!*\
  !*** ./src/js/sections/_guide.js ***!
  \***********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
if (document.querySelector('.guide')) {
  new _functions_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('.guide').renderTab();
  const guide = document.querySelector('.guide');
  guide.addEventListener('click', e => {
    if (e.target.closest('.tabs__btn')) {
      const btnData = e.target.dataset.tabsPath;
      const self = e.currentTarget;
      self.querySelector('.guide-slider__prev').dataset.swiperTestPrev = btnData;
      self.querySelector('.guide-slider__next').dataset.swiperTestNext = btnData;
    }
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/tabs */ "./src/js/functions/tabs.js");
/* harmony import */ var _functions_accordeon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../functions/accordeon */ "./src/js/functions/accordeon.js");


if (document.querySelector('.photos')) {
  new _functions_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('.photos').renderTab();
  new _functions_accordeon__WEBPACK_IMPORTED_MODULE_1__["default"]('.photos').renderAccordeonDefault();
}

/***/ }),

/***/ "./src/js/sections/_preloader.js":
/*!***************************************!*\
  !*** ./src/js/sections/_preloader.js ***!
  \***************************************/
/***/ (() => {
