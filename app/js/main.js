...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    renderPrice() {
      ...
      const total = (0,_calculator__WEBPACK_IMPORTED_MODULE_0__["default"])(width, height, thickness, thickness, this.selectedTable);
      return total;
    }
  },
  template: `
      ...
      if (item) {
        ...
        this.items.forEach(currentItem => {
          if (currentItem !== item && currentItem.classList.contains('active')) {
            ...
            currentItem.querySelector('.accordion-item__body').style.maxHeight = null;
          }
        });
    ...
    this.tabContainer.addEventListener('click', e => {
      if (e.target.classList.contains('tabs-btn')) {
        const tabsHandler = path => {
          ...
          this.tabContainer.querySelector(`[data-tabs-target="${path}"]`).classList.add('tabs-content-active');
        };
        const tabsPath = e.target.dataset.tabsPath;
        this.tabsBtn.forEach(el => {
          el.classList.remove('tabs-btn-active');
        });
        document.querySelector(`[data-tabs-path="${tabsPath}"]`).classList.add('tabs-btn-active');
...
if (document.querySelector('.guide')) {
  const buttonsCollection = document.querySelectorAll('[data-slider-arrows]');
  ...
  guide.addEventListener('click', e => {
    if (e.target.closest('.tabs-btn')) {
      ...
      self.querySelector(`[data-slider-arrows=${btnData}]`).classList.add('active');
    }
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _functions_tabs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../functions/tabs */ "./src/js/functions/tabs.js");
/* harmony import */ var _functions_accordion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../functions/accordion */ "./src/js/functions/accordion.js");


if (document.querySelector('.photos')) {
  new _functions_tabs__WEBPACK_IMPORTED_MODULE_0__["default"]('.photos').renderTab();
  new _functions_accordion__WEBPACK_IMPORTED_MODULE_1__["default"]('.photos').renderaccordionDefault();
}
